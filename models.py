...
class Student(Base):
    ...
    id:Mapped[int]=mapped_column(BigInteger,primary_key=True,autoincrement=True); name:Mapped[str]=mapped_column(String(80),nullable=False); phone_last4:Mapped[str]=mapped_column(String(4),nullable=False); nfc_token:Mapped[str]=mapped_column(String(160),nullable=False,unique=True,index=True); nfc_active:Mapped[bool]=mapped_column(Boolean,default=True,nullable=False); created_at:Mapped[datetime]=mapped_column(DateTime(timezone=True),default=utcnow,nullable=False); updated_at:Mapped[datetime]=mapped_column(DateTime(timezone=True),default=utcnow,nullable=False)
